...
@section('main_content')
    <div class="container-fluid basic_table">
        ...
        <div class="row">
            ...
            @include('admin.permissions.components.permissions-count')

            <div class="col-xxl-4 col-lg-6 box-col-6">
                <div class="card">
                    <div class="card-header">
                        <h4>Total Permissions Per Role</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="total-num counter">
                                    <div class="d-flex by-role custom-scrollbar">
                                        @foreach (allRolesWithPermissionCount() as $role)
                                            <div>
                                                <div class="total-user bg-light-primary">
                                                    <h5> {{ $role->name }} </h5>
                                                    <span class="total-num counter">{{ sprintf("%02d",$role->permissions->count()) }}</span>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                    ...
                    <div class="card-block row">
                        <div class="user-table">
                            <div class="table-responsive p-3">
                                <livewire:roles.components.update-roles />
                            </div>
                        </div>
                    </div>
                </div>
